        ...
        <div class="container">
            <div class="row">
                <div id="sidebar" class="col-md-3">
                     <!--<form action="#" method="post" class="form-inlne" style="margin: -7px 0px -23px 0px;width: 222px;"> 
                            <select class="form-control select2" name="rolename"  placeholder="Filter by location" id="txtSearch" style="border-color: #ccc;width: 100%;">
                ...
                <div class="col-md-9">	
                    ...
                    <div class="thumbnails">
                        ...
                        <c:forEach var="products" items="${productsbylocation}">
